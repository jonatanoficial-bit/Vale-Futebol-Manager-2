export const BETA_Teste_VERSION = 'public-ui';
export const BETA_Teste_SCHEMA = 820;
export const BETA_Teste_BUILD_TIME = '2026-06-26 11:13:18 BRT';

export const BETA_Teste_CRITICAL_ROUTES = [
  ...
  {route:'betaProfessional', label:'Painel do jogo', step:'quality gate geral'},
  {route:'betaQaCenter', label:'Teste rápido', step:'roteiro de teste final'}
];

export const BETA_Teste_DEVICE_MATRIX = [
  ...
  {id:'slow-network', label:'Rede lenta', width:'carregamento seguro', target:'jogo novo, imagens prontas e proteção visual'}
];

export const BETA_Teste_FIRST_SESSION = [
  'Abrir a URL publicada e confirmar que a entrada está limpa.',
  ...
  'Depois de publicar, usar Ctrl+F5 uma vez se o navegador ainda mostrar versão antiga.'
];

export const BETA_Teste_NO_GO_ITEMS = [
