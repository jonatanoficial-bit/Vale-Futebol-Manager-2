...
function trainingScreen(state={}){
  ...
  return `<section class="training-v110 weekly-training-v770">
    <div class="panel weekly-training-hero-v770"><div><span class="tag">Treino Semanal Realista · v7.7.0 · Fase 60</span><h1>Microciclo profissional de 7 dias</h1><p class="small">Recuperação, tático, físico, bola parada, finalização, coletivo e descanso agora formam uma semana real. O treino altera fadiga, risco de lesão, prontidão e impacto direto no motor da partida.</p></div><div class="row gap"><button class="main-btn" data-action="training-apply-week">Aplicar microciclo completo</button><button class="secondary-btn" data-route="calendar">Calendário vivo</button><button class="secondary-btn" data-route="match">Testar no jogo</button></div></div>
